...
<html lang="en">
  ...
  <body>
    <nav class="navbar">
      <div class="container">
        ...
        <ul>
          ...
          <li><a href="#"><?= $language ? $language['about_us'] : 'About Us' ?></a></li>
          <li><a href="#"><?= $language ? $language['contact_us'] : 'Contact Us' ?></a></li>
    ...
    <footer>
      <div class="container">
        <div class="copyright"><?= $language ? $language['copyright'] : 'Copyright' ?> &copy; 2022</div>
      </div>
    </footer>
  </body>
</html>
